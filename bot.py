# bot.py
# ULTIMATE SMS BOMBER BOT - COMPLETE FINAL VERSION
...
async def auto_stop_timer(user_id, update, context):
...
async def process_bomb(update, phone, count):
    ...
    asyncio.create_task(auto_stop_timer(user_id, update, context))
    ...
    if stopped:
        ...
        db.add_bomb_stats(user_id, phone, success + failed, success, failed, total_cost, speed, 1)
    else:
        db.add_bomb_stats(user_id, phone, success + failed, success, failed, total_cost, speed, 0)
...
async def stop(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id in active_bombs and active_bombs[user_id]['active']:
        ...
        await update.message.reply_text(
            ...
            "💡 Use /bomb200, /bomb500, or /bombul to start bombing.",
            parse_mode='Markdown'
        )
