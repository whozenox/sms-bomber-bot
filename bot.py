#!/usr/bin/env python
# ULTIMATE BOMBER BOT - COMPLETE PERFECT
...
from config import ADMIN_IDS, BOT_TOKEN, OWNER, CHANNEL1, CHANNEL2, BOT_NAME, BOT_VERSION, BOMB_COST, FREE_COINS, MAX_SMS_PER_BOMB
